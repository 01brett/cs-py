...
class LinkedListTests(unittest.TestCase):
    ...
    def test_contains(self):
        self.list.add_to_tail(30)
        self.list.add_to_tail(40)
        self.assertTrue(self.list.contains(40))
        self.assertTrue(self.list.contains(30))
        self.assertEqual(self.list.remove_tail(), 40)
        self.assertEqual(self.list.remove_tail(), 30)
        self.assertIsNone(self.list.remove_tail())
        ...
        self.assertEqual(self.list.head.value, 100)
        self.assertEqual(self.list.tail.value, 100)
        self.assertEqual(self.list.remove_tail(), 100)
        self.assertIsNone(self.list.remove_tail())
    ...
    def test_get_max(self):
        ...
        self.list.add_to_tail(30)
        self.list.add_to_tail(40)
        self.list.add_to_tail(60)
        self.list.add_to_tail(50)
        self.assertEqual(self.list.get_max(), 60)
        self.assertEqual(self.list.remove_tail(), 50)
        self.assertEqual(self.list.remove_tail(), 60)
        self.assertEqual(self.list.remove_tail(), 40)
        self.assertEqual(self.list.remove_tail(), 30)
        self.assertIsNone(self.list.remove_tail())
